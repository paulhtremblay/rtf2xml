...
import sys, os, tempfile, rtf2xml.copy, rtf2xml.field_strings, re
class FieldsSmall:
    """
=================
Purpose
...
rtf2xml.field_strings to process it. Write the processed string to the output
file.
    ...
    def __initiate_values(self):
        ...
        self.__string_obj = rtf2xml.field_strings.FieldStrings(bug_handler = self.__bug_handler)
    ...
    def __bookmark_func(self, line):
        ...
        Logic:
            ...
            processes the string with the rtf2xml.fields_string module, and

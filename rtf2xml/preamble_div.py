...
import rtf2xml.list_table
import rtf2xml.override_table
class PreambleDiv:
    """
    ...
    def __initiate_values(self):
        ...
        self.__list_table_obj = rtf2xml.list_table.ListTable(
...
cw<ci<font-style<nu<0
    ...
    def __found_override_table_func(self, line):
        self.__override_table_obj = rtf2xml.override_table.OverrideTable(
            run_level = self.__run_level,
